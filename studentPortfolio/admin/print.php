...
$sql=mysqli_query($con,"select * from student where id=$cid");
$cnt=1;
    ...
    ?>
        ...
        <table cellpadding="0" cellspacing="0">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                               ...
                               <b> Student Name: </b>  <?php echo htmlentities($row['courseName']);?><br>
                                <b> Student Course Enroll Date:</b> <?php echo htmlentities($row['creationDate']);?><br>
                                <b> Student Course Update Date:</b> <?php 
                                    $val = $row['updationDate'];
                                    if($val == NULL){
                                        echo "Not Updated";
                                    }else{
            ...
            <tr class="item">
                ...
                <td>
                    <?php echo htmlentities($row['sessionName']);?>
                </td>
            </tr>
