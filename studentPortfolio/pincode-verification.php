...
{
$sql=mysqli_query($con,"SELECT * FROM  staff where pincode='".trim($_POST['pincode'])."' && StaffRegno='".$_SESSION['login']."'");
 ...
 ?>
    ...
    <div class="content-wrapper">
        <div class="container">
              <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Teacher Pincode Verification</h1>
                    </div>
                </div>
                <div class="row" >
